 ...
 *
 * Resource: /local/hades-budget-card.js?v=8
 */
...
class HadesBudgetWeekCard extends HTMLElement {
  ...
  async _loadWeek(){
    try{const r=await fetch(`${BUDGET_API}/api/v1/week/current`,{headers:HEADERS});this._week=await r.json();this._loading=false;this._render();}
